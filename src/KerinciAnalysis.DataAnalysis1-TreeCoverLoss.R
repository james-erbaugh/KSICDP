...
spatpod03<-read.csv("C:/Users/f003r0x/Dropbox/Library/1.Data/Dissertation_Data/Spatial_Datatables/xwalk_wide_merged2003d_lags.csv")
spatpod_fullset<-read.csv("C:/Users/f003r0x/Dropbox/Library/1.Data/Dissertation_Data/Spatial_Datatables/xwalk_wide_mergedalld2_lags2.csv")
...
ksnpvca<-read.csv("C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/KSNP-VilNames-ICDP_HKD.csv")
...
#write.csv(yrforloss_KSNP,"C:/Users/f003R0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/yrforloss_KSNP.csv")
...
#write.csv(spatpod.ksnp_mtch_all3,"C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/spatpod.ksnp_mtch_all.csv")
...
ksnp_mtch1.2
#write.csv(ksnp_mtch_mah2, "C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/ksnp_mtch_mah2.csv")
...
ksnp_mtch2.2
#write.csv(ksnp_mtch_full2, "C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/ksnp_mtch_full2.csv")
...
ksnp_mtch3.2
#write.csv(ksnp_mtch_gen2, "C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/ksnp_mtch_gen2.csv")
...
###   Writing Dataset   ################################################################################################
#write.csv(yrforloss_KSNP_wts, "C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/yrforloss_KSNP_wts.csv")

###   Preparing to save as .dta for stata   ###
yrforloss_KSNP_wts_dta<-yrforloss_KSNP_wts

yrforloss_KSNP_wts_dta$pop_2000<-yrforloss_KSNP_wts_dta$pop.2000
yrforloss_KSNP_wts_dta$pop.2000<-NULL

yrforloss_KSNP_wts_dta$Combined_Boundary<-yrforloss_KSNP_wts_dta$Combined.Boundary
yrforloss_KSNP_wts_dta$Combined.Boundary<-NULL

###   Writing Data for Long-Term Analysis   ###
write_dta(yrforloss_KSNP_wts_dta, "C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/yrforloss_KSNP_wts.dta", version=14)

###   Writing Data for Short-Term Analysis   ###
yrforloss_KSNP_wts_dta_shortterm<-yrforloss_KSNP_wts_dta %>%
  filter(year<2008)

#write_dta(yrforloss_KSNP_wts_dta_shortterm, "C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/Data/yrforloss_KSNP_wts_shortterm.dta", version=14)
...
# ggsave(file="C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/timetrends_shortterm.png",
#        plot=timetrends,
...
##Combining KSNP and overall forest loss time trend graphs##
timetrends<-ggarrange(allloss_plot, nonKSNPloss_plot, ksnploss_plot, nrow=3, common.legend=T, labels="AUTO")
#timetrends<-annotate_figure(timetrends,left=text_grob("Mean Tree-Cover Loss (Ha)", rot = 90))
timetrends

 ggsave(file="C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/timetrends_longterm.png",
        plot=timetrends,
        dpi=600, width=8, height=6, unit="in") 
...
# ggsave(file="C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/timetrends_longterm_NOSB.png",
...
# ggsave(file="C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/timetrends_shortterm_VCAonly.png",
...
###   VCA award disbursed by total forest cover loss 2000-2016 (DATA TREATMNET)   ###
yrforloss_KSNP_wts_tmp<-yrforloss_KSNP_wts %>% 
  select(ID2003_d, HKD, VCA,  KSNP_AreaForLoss_Ha2, nonKSNP_AreaForLoss_Ha,  All_AreaForLoss_Ha)

yrforloss_KSNP_wts_tmp$HKD[yrforloss_KSNP_wts_tmp$HKD>250000000]<-yrforloss_KSNP_wts_tmp$HKD[yrforloss_KSNP_wts_tmp$HKD>250000000]/2

yrforloss_KSNP_wts_tmp2<-yrforloss_KSNP_wts_tmp %>%
  group_by(ID2003_d) %>% 
  dplyr::summarize(ksnpforloss=sum(KSNP_AreaForLoss_Ha2, na.omit=T),
                   nonksnpforloss=sum(nonKSNP_AreaForLoss_Ha, na.omit=T),
                   allforloss=sum(All_AreaForLoss_Ha, na.omit=T),
                   hkd=mean(HKD, na.omit=T),
                   vca=mean(VCA)) 
yrforloss_KSNP_wts_tmp2$hkd2<-0
yrforloss_KSNP_wts_tmp2$hkd2[yrforloss_KSNP_wts_tmp2$hkd==0]<-"Non-VCA"
yrforloss_KSNP_wts_tmp2$hkd2[yrforloss_KSNP_wts_tmp2$hkd>0 & yrforloss_KSNP_wts_tmp2$hkd<(2*10^8)]<-"Partial Disbursal"
yrforloss_KSNP_wts_tmp2$hkd2[yrforloss_KSNP_wts_tmp2$hkd>(2*10^8)]<-"Full Disbursal"
yrforloss_KSNP_wts_tmp3<-yrforloss_KSNP_wts_tmp2 %>% 
  gather(key = "forest", value="forestloss", -ID2003_d, -hkd, -hkd2, -vca) %>% 
  arrange(ID2003_d, forest)
table(yrforloss_KSNP_wts_tmp3$hkd2, yrforloss_KSNP_wts_tmp3$forest)

std <- function(x) sd(x)/sqrt(length(x))

yrforloss_KSNP_wts_tmp4<-yrforloss_KSNP_wts_tmp3 %>% 
  filter(forest!="allforloss"  ) %>% 
  group_by(forest, vca)  %>% 
  filter(forestloss<1.5*IQR(forestloss)) %>% 
  dplyr::summarize(mean=mean(forestloss, na.omit=T),
                   stde=(std(forestloss))) %>% 
  mutate(ci_min=mean-(1.96*stde),
         ci_max=mean+(1.96*stde))

yrforloss_KSNP_wts_tmp5<-yrforloss_KSNP_wts_tmp3 %>% 
  filter(forest!="allforloss"  ) %>% 
  group_by(forest, hkd2)  %>% 
  filter(forestloss<1.5*IQR(forestloss)) %>% 
  dplyr::summarize(mean=mean(forestloss, na.omit=T),
            stde=(std(forestloss))) %>% 
  mutate(ci_min=mean-(1.96*stde),
...
###  Plotting VCA and HKD trends for forest cover change
vca_0<-ggplot(yrforloss_KSNP_wts_tmp4, 
              aes(x=forest, y=mean, fill=factor(vca), ymin=ci_min, ymax=ci_max)) + 
  geom_col(position="dodge", width=0.75) +
  geom_errorbar(width=.25, position=position_dodge(0.75))+
  #geom_point(color="black") +
  #geom_hline(yintercept=.33, linetype="dashed") +
  #coord_cartesian(ylim=c(0,1000))+
  #facet_wrap(~mtch)+
  labs(x = "Type of Forest Loss", y="Average Loss per Village (ha)")+
  theme_bw()
vca_0

##   NOTE: THIS IS PERFORMED WITHOUT OUTLIERS

hkd_0<-ggplot(yrforloss_KSNP_wts_tmp5, 
              aes(x=forest, y=mean, fill=factor(hkd2), ymin=ci_min, ymax=ci_max)) + 
  geom_col(position="dodge", width=0.75) +
  geom_errorbar(position=position_dodge(0.75), width=.25)+
  #geom_point(color="black") +
  #geom_hline(yintercept=.33, linetype="dashed") +
  #coord_cartesian(ylim=c(0,1000))+
  #facet_wrap(~mtch)+
...
hkd_1<-ggplot(yrforloss_KSNP_wts_tmp2, 
              aes(x=hkd, y=nonksnpforloss)) + 
  geom_smooth(method="loess", span=1) +
  geom_point(color="black") +
  #geom_hline(yintercept=.33, linetype="dashed") +
  coord_cartesian(ylim=c(0,5000))+
  #facet_wrap(~mtch)+
  labs(x = "VCA Award Disbursed", y="Non-KSNP")+
  theme_bw()
hkd_1
##   Note:
sum((yrforloss_KSNP_wts_tmp2$nonksnpforloss>3000))

hkd_2<-ggplot(yrforloss_KSNP_wts_tmp2, 
              aes(x=hkd, y=ksnpforloss)) + 
  geom_smooth(method="loess", span=1) +
  geom_point(color="black") +
  #geom_hline(yintercept=.33, linetype="dashed") +
  coord_cartesian(ylim=c(0,5000))+
  #facet_wrap(~mtch)+
  labs(x = "VCA Award Disbursed", y="KSNP")+
  theme_bw()
hkd_2

HKD_trends<-ggarrange(hkd_1, hkd_2, nrow=2)
HKD_trends

#yrforloss_KSNP_wts_tmp2 %>% filter(nonksnpforloss<2*IQR(nonksnpforloss))
#yrforloss_KSNP_wts_tmp2 %>% filter(nonksnpforloss<2*IQR(ksnpforloss)
...
# ggsave(file="C:/Users/JTErbaugh/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/plot_dich_dist_rds_07.png",
...
# ggsave(file="C:/Users/JTErbaugh/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/plot_cont_dist_rds_07.png",
...
# ggsave(file="C:/Users/f003r0x/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/ksnp_bothplots.png",
#        plot=ksnp_did_both,
#        dpi=600, width=6.5, height=4, unit="in")
...
ggsave(file="C:/Users/JTErbaugh/Dropbox/_DarmouthPostDoc/Publications/2.In_Review/KerinciConsLegacy/plot-check1.png",
